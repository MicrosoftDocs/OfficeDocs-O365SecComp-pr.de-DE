...
5. Geben Sie den Namen, die Beschreibung sowie Einstellungen für Ihre Richtlinie an. Weitere Informationen finden Sie unter Informationen [zu Optionen für die ATP-AntiPhishing-Richtlinie](#learn-about-atp-anti-phishing-policy-options) . 
