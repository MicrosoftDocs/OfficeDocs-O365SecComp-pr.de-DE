...
Nachdem Sie festgestellt haben, dass ein Postfach in der Warteschleife ist, da eine Beschriftung für die Aufbewahrung auf einen Ordner oder ein Element angewendet wird, können das Inhaltssuche-Tool in der & Security Compliance Center Sie mithilfe der ComplianceTag Suchbedingung nach gekennzeichneten Elementen suchen. Weitere Informationen finden Sie im Abschnitt "Suchen Conditions" in [Stichwortabfragen und Suchkriterien für die Inhaltssuche](keyword-queries-and-search-conditions.md#conditions-for-common-properties).
