...
- [Darüber hinaus](security-roadmap.md#Beyond)
...
|Darüber hinaus|Passen Sie an und verfeinern Sie Hauptrichtlinien und Steuerelemente  <br/> Erweitern Sie lokale Abhängigkeiten Mauer  <br/> Integrieren Sie in Geschäfts- und sicherheitsanforderungen Prozesse (Legal, Bedrohung von innen usw.).  <br/> |
...
|Informationen proteciton  <br/> | • Verfeinern Richtlinien und betriebliche Prozesse.  <br/>  • Verwenden Sie zum Identifizieren der Bedrohungen Insider Azure AD-Schutz.  <br/> |
