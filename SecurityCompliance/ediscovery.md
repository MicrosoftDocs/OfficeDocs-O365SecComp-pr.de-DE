...
Die folgende Tabelle enthält Links zu Themen, die Sie bei der Verwendung des Inhalts Such Tools im Security & Compliance Center unterstützen sollen.
...
|[Verwenden eines Skripts zum Hinzufügen von Benutzern zu einem Haltestatus in einem eDiscovery-Fall im Security & Compliance Center](use-a-script-to-add-users-to-a-hold-in-ediscovery.md) <br/> |Hier erfahren Sie, wie Sie mithilfe des Windows PowerShell Skripts in diesem Artikel schnell die Postfächer und OneDrive für Unternehmen Websites für eine Liste von Benutzern zu einem neuen Haltebereich hinzufügen, der einem eDiscovery-Fall im Security & Compliance Center zugeordnet ist.  <br/> |
...
Die folgende Tabelle enthält Links zu Themen, in denen Sie mehr über das erweiterte eDiscovery-Tool in Office 365 erfahren und verwenden können.
  
|**Thema**|**Beschreibung**|
|:-----|:-----|
|[Office 365 Advanced eDiscovery](office-365-advanced-ediscovery.md) <br/> |Erfahren Sie, wie Sie mit dem erweiterten eDiscovery-Tool Daten in Office 365 analysieren, Dokumentüberprüfungen optimieren und Entscheidungen für effiziente eDiscovery treffen können.  <br/> |
|[Schnelles Setup für Advanced eDiscovery](quick-setup-for-advanced-ediscovery.md) <br/> |Hier erfahren Sie, wie Sie mit Advanced eDiscovery beginnen.  <br/> |
|[Vorbereiten der Suchergebnisse für Erweiterte eDiscovery in Office 365](prepare-search-results-for-advanced-ediscovery.md) <br/> |In diesem Artikel erfahren Sie, wie Sie die Ergebnisse einer Inhaltssuche für die Analyse in Advanced eDiscovery vorbereiten.  <br/> |
|[Einrichten von Benutzern und Fällen in Office 365 Advanced eDiscovery](set-up-users-and-cases-in-advanced-ediscovery.md) <br/> |Informationen zum Konfigurieren von Benutzerrollen, Erstellen von Fällen und Zuweisen von Benutzern zu Fällen in Advanced eDiscovery.  <br/> |
|[Ausführung des Prozess Moduls und Laden von Daten](run-the-process-module-and-load-data-in-advanced-ediscovery.md) <br/> |Erfahren Sie mehr über die Richtlinien für die Vorbereitung von Fall Dateien für die Analyse mit Advanced eDiscovery.  <br/> |
|[Verwenden der Express Analyse in Office 365 Advanced eDiscovery](use-express-analysis-in-advanced-ediscovery.md) <br/> |Hier erfahren Sie, wie Sie den Express-Analysemodus von Advanced eDiscovery ausführen, um einen Fall schnell zu analysieren und die Ergebnisse zu exportieren.  <br/> |
|[Analysieren von Case-Daten mit Advanced eDiscovery](analyze-case-data-with-advanced-ediscovery.md) <br/> |Erhalten Sie einen Überblick über den Analyseprozess, mit dem Sie Parameter festlegen, Optionen ausführen und Ergebnisse in Advanced eDiscovery anzeigen können.  <br/> |
|[Verwalten des Setups für die erweiterte eDiscovery-Relevanz](manage-relevance-setup-in-advanced-ediscovery.md) <br/> |Lesen Sie die Empfehlungen zum Einrichten von Relevanz-Schulungen in Advanced eDiscovery, um Dateien anhand ihrer Relevanz zu bewerten und analytische Ergebnisse zu generieren.  <br/> |
|[Verwenden des Moduls für die erweiterte eDiscovery-Relevanz](use-relevance-in-advanced-ediscovery.md) <br/> |In diesem Artikel erfahren Sie mehr über das Modul "Relevanz" in Advanced eDiscovery, einschließlich eines Workflows sowie Richtlinien und Schritte zur Schulung und Dateiüberprüfung.  <br/> |
|[Exportieren von Case-Daten mit Advanced eDiscovery](export-case-data-in-advanced-ediscovery.md) <br/> |Grundlegendes zu den Richtlinien für den Export von eDiscovery-Falldaten und Ergebnissen für die externe Überprüfung.  <br/> |
|[Höhere Downloadgeschwindigkeit beim Exportieren von eDiscovery-Suchergebnissen aus Office 365](increase-download-speeds-when-exporting-ediscovery-results.md) <br/> |Hier erfahren Sie, wie Sie die Windows-Registrierung so konfigurieren, dass die Downloadgeschwindigkeit beim Exportieren von Falldaten aus Advanced eDiscovery erhöht wird.  <br/> |
