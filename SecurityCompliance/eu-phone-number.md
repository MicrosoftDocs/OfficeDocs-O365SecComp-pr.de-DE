...
---
# <a name="eu-phone-number"></a>EU-Telefonnummer

Verhinderung von Datenverlust (DLP) in die Office 365-Sicherheit &amp; Compliance Center enthält viele Arten von vertraulichen Informationen, die Sie in Ihrer DLP-Richtlinien verwendet werden. In diesem Thema wird den Typ der Telefonnummer EU-vertrauliche Informationen. 
  
## <a name="austria"></a>Österreich

### <a name="format"></a>Format

Keine standard Länge
  
### <a name="pattern"></a>Muster

- Ziffern 
    
- Nur Mobiltelefone beginnen mit der Ziffer "6" 
...
- Der reguläre Ausdruck `Regex_austria_eu_telephone_number_1` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_austria_eu_telephone_number` gefunden wird. 
    
Eine DLP-Richtlinie ist zu 75 % sicher, dass diese Art von vertraulichen Informationen erkannt wurde, wenn Folgendes innerhalb von 300 Zeichen zutrifft:
  
- Der reguläre Ausdruck `Regex_austria_eu_telephone_number_2` sucht nach Inhalten, die dem Muster entspricht. 
...
- Der reguläre Ausdruck `Regex_belgium_eu_telephone_number_1` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_belgium_eu_telephone_number` gefunden wird. 
    
Eine DLP-Richtlinie ist zu 75 % sicher, dass diese Art von vertraulichen Informationen erkannt wurde, wenn Folgendes innerhalb von 300 Zeichen zutrifft:
  
- Der reguläre Ausdruck `Regex_belgium_eu_telephone_number_2` sucht nach Inhalten, die dem Muster entspricht. 
...
- Der reguläre Ausdruck `Regex_bulgaria_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_bulgaria_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_croatia_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_croatia_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_cyprus_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_cyprus_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_czech_republic_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_czech_republic_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_denmark_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_denmark_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_estonia_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_estonia_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_finland_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_finland_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_france_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_france_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_germany_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_germany_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_greece_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_greece_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_hungary_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_hungary_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_ireland_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_ireland_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_italy_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_italy_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_latvia_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_latvia_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_lithuania_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_lithuania_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_luxemburg_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_luxemburg_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_malta_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_malta_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_netherlands_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_netherlands_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_poland_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_poland_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_portugal_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_portugal_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_romania_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_romania_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_slovakia_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_slovakia_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_slovenia_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_slovenia_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_spain_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_spain_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_sweden_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_sweden_eu_telephone_number` gefunden wird. 
...
- Der reguläre Ausdruck `Regex_uk_eu_telephone_number` sucht nach Inhalten, die dem Muster entspricht. 
    
- Ein Schlüsselwort aus `Keywords_uk_eu_telephone_number` gefunden wird. 
