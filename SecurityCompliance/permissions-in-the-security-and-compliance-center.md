...
Im Office 365 Security & Compliance Center können Sie Personen, die Compliance-Aufgaben wie Geräteverwaltung, Verhinderung von Datenverlust, eDiscovery, Aufbewahrung usw. ausführen, Berechtigungen erteilen. Diese Personen können nur die Aufgaben ausführen, denen Sie explizit Zugriff gewähren. Um auf das Security & Compliance Center zugreifen zu können, müssen Benutzer ein Office 365 globaler Administrator oder ein Mitglied einer oder mehrerer Sicherheits & Compliance Center-Rollengruppen sein.
  
Berechtigungen im Security & Compliance Center basieren auf dem Berechtigungsmodell der rollenbasierten Zugriffssteuerung (Role Based Access Control, RBAC). Dies ist das gleiche Berechtigungsmodell, das von Exchange verwendet wird, wenn Sie also mit Exchange vertraut sind, werden das Gewähren von Berechtigungen im Security & Compliance Center sehr ähnlich sein. Beachten Sie jedoch, dass die Rollengruppen "Exchange role groups" und "Security & Compliance Center" keine Mitgliedschaft oder Berechtigungen gemeinsam nutzen. Zwar verfügen beide über eine Rollengruppe "Organisationsverwaltung", sie sind jedoch nicht identisch. Die erteilten Berechtigungen und die Mitglieder der Rollengruppen sind verschieden. Unten finden Sie eine Liste der Rollengruppen Security & Compliance Center.
...
In der folgenden Tabelle sind die Standardrollengruppen aufgelistet, die im Security & Compliance Center zur Verfügung stehen, sowie die Rollen, die standardmäßig den Rollengruppen zugewiesen sind. Um einem Benutzerberechtigungen zum Ausführen einer Konformitäts Aufgabe zu erteilen, fügen Sie ihn der entsprechenden Sicherheits & Compliance Center-Rollengruppe hinzu.
  
Durch die Verwaltung von Berechtigungen im Security & Compliance Center können Benutzer nur auf die Compliance-Features zugreifen, die im Security & Compliance Center selbst verfügbar sind. Wenn Sie Berechtigungen für andere Kompatibilitätsfeatures gewähren möchten, die sich nicht im Security & Compliance Center befinden, wie Exchange-Nachrichtenfluss Regeln (auch bekannt als Transportregeln), müssen Sie das Exchange Admin Center verwenden.
  
Informationen zum Gewähren des Zugriffs auf das Security & Compliance Center finden Sie unter Erteilen von [Benutzern Zugriff auf Office 365 Compliance Admin Center](grant-access-to-the-security-and-compliance-center.md).
...
|**Custodian**|Erstellen, bearbeiten, löschen und Steuern des Zugriffs auf depotverwalter.|eDiscovery-Manager|
...
|**Dispositionsverwaltung**|Steuern der Berechtigungen für den Zugriff auf die manuelle Disposition im Security & Compliance Center.|Complianceadministrator <br/><br/> Kompatibilitätsdaten Administrator <br/><br/> Organisationsverwaltung|
