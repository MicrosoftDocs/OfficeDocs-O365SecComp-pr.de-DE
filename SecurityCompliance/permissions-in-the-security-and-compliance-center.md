...
Berechtigungen im Security &amp; Compliance Center basieren auf dem Berechtigungsmodell für die rollenbasierte Zugriffssteuerung. Dies ist das gleiche Berechtigungsmodell, das von Exchange verwendet wird, wenn Sie also mit Exchange vertraut sind, ist das Gewähren von &amp; Berechtigungen im Security Compliance Center sehr ähnlich. Beachten Sie jedoch, dass Exchange-Rollengruppen und Sicherheits &amp; Kompatibilitäts Center-Rollengruppen keine Mitgliedschaft oder Berechtigungen gemeinsam nutzen. Während beide eine Organisations Verwaltungsrollengruppe haben, sind Sie nicht identisch. Die Berechtigungen, die Sie gewähren, und die Mitglieder der Rollengruppen sind unterschiedlich. Nachfolgend finden Sie eine Liste &amp; der Rollengruppen Security Compliance Center.
...
Sie können die vorhandenen Rollengruppen bearbeiten oder löschen, aber dies wird nicht empfohlen. Anstatt eine Standardrollengruppe zu bearbeiten, können Sie Sie kopieren, ändern und dann unter einem anderen Namen speichern.
...
|**Aufsichtsüberprüfung** <br/> |Mitglieder können die Richtlinien erstellen und verwalten, die definieren, welche Kommunikation in einer Organisation überprüft werden soll. Weitere Informationen finden Sie unter [configure Supervisory Review Policies for your organization](configure-supervision-policies.md).<br/> |
