...
|***E-Mail-Authentifizierung*** <br/> |Ja  <br/> |E-Mail-Authentifizierung verwendet ein Domain Name System (DNS), um e-Mail-Nachrichten über den Absender einer e-Mail überprüfbaren Informationen hinzuzufügen. Office 365 richtet e-Mail-Authentifizierung für die Standarddomäne ("onmicrosoft.com"), aber Office 365-Administratoren können auch e-Mail-Authentifizierung für benutzerdefinierte Domänen. Drei Authentifizierungsmethoden werden verwendet:<br/> <br> &ensp;&ensp;• Sender Policy Framework (oder SPF).<br/>&ensp;&ensp;&ensp;&ensp;-Setup aus finden Sie unter [Einrichten von SPF in Office 365, um spoofing zu verhindern](set-up-spf-in-office-365-to-help-prevent-spoofing.md). <br/> &ensp;&ensp;• DomainKeys identifiziert Mail (DKIM). <br/> &ensp;&ensp;&ensp;&ensp;-Finden Sie unter [Verwendung von DKIM e-Mail in Ihrer benutzerdefinierten Domäne in Office 365](https://docs.microsoft.com/office365/SecurityCompliance/use-dkim-to-validate-outbound-email). <br>&ensp;&ensp;&ensp;&ensp;-Nachdem Sie DKIM konfiguriert haben, aktivieren Sie es in das Wertpapier &amp; Compliance Center.<br/> &ensp;&ensp;• Nachricht domänenbasierte Authentifizierung Reporting und Konformität (DMARC). </br> &ensp;&ensp;&ensp;&ensp;-Richten Sie für DMARC [DMARC verwenden, um e-Mail in Office 365 zu überprüfen](use-dmarc-to-validate-email.md).<br/>  <br/>
|
