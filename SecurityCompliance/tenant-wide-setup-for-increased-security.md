...
|**Antischadsoftware-Modul** <br/> |Ja  <br/> | Bearbeiten der Standardrichtlinie:  <br/> &ensp;&ensp;• Allgemeine Anlage Typen Filter – wählen Sie aus  <br/><br>  Sie können auch benutzerdefinierte Malware Filterrichtlinien erstellen und anwenden auf bestimmte Benutzer, Gruppen oder Domänen in Ihrer Organisation.  <br/> <br> Weitere Informationen:  <br/> &ensp;&ensp;• [Anti-Malware protection](https://technet.microsoft.com/en-us/library/jj200669%28v=exchg.150%29.aspx) <br/> &ensp;&ensp;• [Konfigurieren Antischadsoftware - Richtlinien](https://technet.microsoft.com/en-us/library/jj200745%28v=exchg.150%29.aspx) <br/> |
|**Sichere Anlagen in ATP** <br/> |Nein  <br/> | Schützen von Dateien in SharePoint, OneDrive und Microsoft-Teams, auf der Hauptseite für sichere Anlagen durch Aktivieren des Kontrollkästchens:  <br/>  &ensp;&ensp;• Schalten ATP für SharePoint, OneDrive und Microsoft-Teams  <br/> <br> Hinzufügen einer neuen Richtlinie für sichere Anlage mit diesen Einstellungen:  <br/>  &ensp;&ensp;• Blockieren – die aktuellen und zukünftigen-e-Mails und Anlagen mit gefundene Malware blockieren (Wählen Sie diese Option)  <br/>  &ensp;&ensp;• Enable umleiten – (Aktivieren Sie dieses Kontrollkästchen, und geben Sie eine e-Mail-Adresse, beispielsweise ein Konto Admin und Quarantäne)  <br/>  &ensp;&ensp;• Die obige Auswahl anwenden, wenn schadsoftwareprüfung für Anlagen Timeout oder Fehler tritt auf, (Aktivieren Sie dieses Kontrollkästchen)  <br/>  &ensp;&ensp;• Auf angewendet – die Domäne des Empfängers ist (Wählen Sie Ihre Domäne)  <br/>  <br>Weitere Informationen: [Einrichten von Richtlinien für Office 365 ATP sichere Anlagen](set-up-atp-safe-attachments-policies.md) <br/> |
|**ATP-sichere Links** <br/> |Ja  <br/> | Fügen Sie diese Einstellung auf die Standardrichtlinie für die gesamte Organisation:  <br/> &ensp;&ensp;• Verwendung sicherer Links in: Office 365 ProPlus, Office für iOS und Android (Wählen Sie diese Option aus).  <br/> <br>Empfohlene Richtlinien für bestimmte Empfänger:  <br/>  &ensp;&ensp;• URLs umgeschrieben werden und mit einer Liste bekannter bösartiger links abgeglichen werden, wenn Benutzer auf den Link klickt (Wählen Sie diese Option aus).  <br/>  &ensp;&ensp;• Verwenden sichere Anlagen zu überprüfenden Bücher (Aktivieren Sie dieses Kontrollkästchen).  <br/>  &ensp;&ensp;• Auf angewendet – die Domäne des Empfängers ist (Wählen Sie Ihre Domäne).  <br/> <br> Weitere Informationen: [Office 365 ATP sichere Links](atp-safe-links.md).  <br/> |
|**Anti-Spam (Mail-Filterung)** <br/> |Ja  <br/> | Was für die Überwachung:  <br/>  &ensp;&ensp;• Zu viel spam – wählen Sie die benutzerdefinierte Einstellungen und bearbeiten die Standardrichtlinie für Spam-Filter.  <br/>  &ensp;&ensp;• Spoofing Intelligence – Absender, die Ihre Domäne spoofing sind überprüfen. Blockieren oder Zulassen von diesen Absendern.<br/>  <br>Weitere Informationen: [Office 365 E-Mail Anti-Spam-Schutz](anti-spam-protection.md).  <br/> |
|***E-Mail-Authentifizierung*** <br/> |Ja  <br/> |E-Mail-Authentifizierung verwendet ein Domain Name System (DNS), um e-Mail-Nachrichten über den Absender einer e-Mail überprüfbaren Informationen hinzuzufügen. Office 365 richtet e-Mail-Authentifizierung für die Standarddomäne ("onmicrosoft.com"), aber Office 365-Administratoren können auch e-Mail-Authentifizierung für benutzerdefinierte Domänen. Drei Authentifizierungsmethoden werden verwendet:<br/> <br> &ensp;&ensp;• Sender Policy Framework (oder SPF). Setup finden Sie unter [Einrichten von SPF in Office 365, um spoofing zu verhindern](set-up-spf-in-office-365-to-help-prevent-spoofing.md).<br/> &ensp;&ensp;• DomainKeys identifiziert Mail (DKIM). Für die Verwendung mit DKIM finden Sie unter [DKIM verwenden, um ausgehende e-Mail-Nachrichten, die von Ihrer benutzerdefinierten Domäne in Office 365 gesendet zu überprüfen](https://docs.microsoft.com/office365/SecurityCompliance/use-dkim-to-validate-outbound-email).<br>&ensp;&ensp;&ensp;&ensp;&ensp;-Nachdem Sie DKIM konfiguriert haben, können Sie es für Ihre Organisation in das Wertpapier &amp; Compliance Center.<br/> &ensp;&ensp;• Nachricht domänenbasierte Authentifizierung Reporting und Konformität (DMARC). Zum Einrichten von DMARC finden Sie unter [Verwendung DMARC e-Mail in Office 365 überprüfen](use-dmarc-to-validate-email.md).<br/>  <br/>
|

> [!NOTE]
> Für nicht standardmäßige SPF-Bereitstellungen, hybridbereitstellungen und Problembehandlung: [wie Office 365 verwendet Sender Policy Framework (SPF), um spoofing zu verhindern](how-office-365-uses-spf-to-prevent-spoofing.md).
