...
5. Geben Sie auf der Seite **Beweissicherungsverfahren** die folgenden optionalen Informationen ein: 
  ...
  - **Hinweis** Verwenden Sie dieses Feld, um dem Benutzer mitzuteilen, dass sein Postfach in einem Rechtsstreit gehalten wird. Die Notiz wird im Postfach des Benutzers angezeigt, wenn Sie Outlook 2010 oder höher verwenden. 
    
  - **URL** Verwenden Sie dieses Feld, um den Benutzer zu einer Website zu leiten, um weitere Informationen zur Aufbewahrung von Rechtsstreitigkeiten zu erhalten. Diese URL wird im Postfach des Benutzers angezeigt, wenn Sie Outlook 2010 oder höher verwenden. 
...
- Wenn Ihre Organisation verlangt, dass alle Postfachdaten für einen bestimmten Zeitraum beibehalten werden müssen, ziehen Sie Folgendes in Betracht, bevor Sie das Beweissicherungsverfahren für alle Postfächer in einer Organisation aktivieren.
  ...
  - Das Platzieren aller Postfächer in einem Rechtsstreit kann sich erheblich auf die Postfachgröße auswirken. Planen Sie in einer Exchange Server 2013-Organisation eine adäquate Speicherung, um die Aufbewahrungsanforderungen Ihrer Organisation zu erfüllen.
    
  - Der Ordner "Wiederherstellbare Elemente" verfügt über einen eigenen Speichergrenzwert, sodass Elemente im Ordner nicht auf den Postfachspeicher Grenzwert angerechnet werden. Wie bereits erläutert, führt das Aufbewahren von Postfachdaten über einen längeren Zeitraum zu einem Wachstum des Ordners "Wiederherstellbare Elemente" im Postfach und Archiv eines Benutzers. Um diese Zunahme in Exchange Online zu bewältigen, wird das Kontingent für den Ordner "Wiederherstellbare Elemente" automatisch von 30 GB auf 100 GB erhöht, wenn Sie ein Postfach für ein Verfahren halten. 
    
    In Exchange Server 2013 beträgt der Standardspeichergrenzwert für den Ordner "Wiederherstellbare Elemente" auch 30 GB. Es wird empfohlen, die Größe dieses Ordners regelmäßig zu überwachen, um sicherzustellen, dass die Grenze nicht erreicht wird. Weitere Informationen finden Sie unter [Ordner "Wiederherstellbare Elemente"](http://technet.microsoft.com/library/efc48fb4-2ed8-4d05-93af-f3505fbc389d.aspx).
