...
## <a name="how-atp-safe-links-works-with-email"></a>Funktionsweise von ATP sichere Links mit e-Mail
...
## <a name="new-features-added-to-atp-safe-links"></a>Neue Funktionen für sichere ATP-Links

Wir entwickeln sicherer Links ATP neue Features hinzufügen. Es folgen einige Beispiele:
...
- Ab Juni 2018, wenn Benutzer Outlook Web Application (OWA) verwenden, ATP sichere Links rendert ursprünglichen URLs und umgeschriebene URLs nicht anzeigen. Dies ermöglicht Benutzern das Anzeigen des ursprünglichen Links in e-Mail. (Wir Aufrufen dieses systemeigenen Link Visbility.)
...
- Verspäteter 2018 ab, ist die systemeigene Link Sichtbarkeit in Outlook zur Verfügung. Benutzer können in e-Mails, die ursprünglichen URLs (URLs nicht umgeschriebene) anzuzeigen, ob Sie ihre OWA oder Outlook verwenden.
    
## <a name="how-to-get-atp-safe-links-protection"></a>Wie sichere Links ATP Protection abrufen

Sichere ATP-Links-Features sind Teil der [Erweiterte Schutz](office-365-atp.md)in Office 365 Enterprise E5 enthalten. Wenn in Ihrer Organisation ein weiteres Abonnement von Office 365 Enterprise verwendet wird, kann der erweiterte Schutz als Add-on erworben werden. Weitere Informationen finden Sie unter [Office 365-Plattformdienstbeschreibung: Sicherheit in Office 365 &amp; Compliance Center](https://technet.microsoft.com/en-us/library/dn933793.aspx) und [gekauft oder bearbeiten Sie ein Add-on für Office 365 für Unternehmen](https://support.office.com/article/4e7b57d6-b93b-457d-aecd-0ea58bff07a6).
