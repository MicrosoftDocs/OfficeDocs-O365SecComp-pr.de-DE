...
|Erstellt an Connection  <br/> |SendToConnectionAdded  <br/> |Ein SharePoint-oder globaler Administrator erstellt eine neue Verbindung senden an auf der Seite Datensatzverwaltung im SharePoint Admin Center. Mit einer Senden-an-Verbindung werden die Einstellungen für ein Dokumentrepository oder ein Datenarchiv festgelegt. Wenn Sie eine Senden-an-Verbindung erstellen, kann die Inhaltsorganisation Dokumente an den angegebenen Speicherort übermitteln.  <br/> |
