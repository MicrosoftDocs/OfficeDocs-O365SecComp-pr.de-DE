...
Eine ausführliche Übersicht über die Unterschiede zwischen der vorherigen Version von OME und die neuen OME-Funktionen finden Sie unter [OME-Versionen verglichen werden soll](ome-version-comparison.md).
...
Die neuen OME-Funktionen werden für die meisten Office 365-Organisationen automatisch aktiviert. Wenn Ihre Organisation nicht automatisch OME aktiviert haben, oder wenn Sie die neuen Funktionen OME deaktiviert, aktiviert, folgen Sie diesen Schritten So richten Sie die neuen Funktionen für OME manuell ein.
