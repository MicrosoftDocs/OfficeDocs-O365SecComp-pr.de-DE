...
Verhinderung von Datenverlust (DLP) in die Office 365-Sicherheit &amp; Compliance Center umfasst kann jetzt zu verwendende Richtlinienvorlagen das allgemeine Compliance-Bestimmungen, wie Sie vertraulichen Informationen müssen der U.S. Health Insurance Act (schützen helfen aufgelistet. HIPAA), USA Gramm-Leach-Bliley Act (GLBA) oder US Patriot Act. In diesem Thema werden alle Richtlinien, Vorlagen, welche Arten von vertraulichen Informationen, die sie für Aussehen und was die standardbedingungen und Aktionen sind. In diesem Thema gibt keinen jedes Detail wie jedes Richtlinienvorlage konfiguriert ist. Stattdessen wird das Thema mit Ihnen genügend Informationen, um Hilfe bei der Entscheidung, welche Vorlage am besten Ausgangspunkt für Ihr Szenario ist. Beachten Sie, dass Sie diese Richtlinienvorlagen, um Ihre spezifischen Bedürfnisse anpassen können.
  
## <a name="australia-financial-data"></a>Finanzdaten - Australien

|**Regelname**|**Bedingungen <br/> (einschließlich Typen vertraulicher Informationen)**|**Aktionen**|
|:-----|:-----|:-----|
...
## <a name="general-data-protection-regulation-gdpr"></a>Allgemeine Data Protection Regulierung (GDPR)

|**Regelname**|**Bedingungen <br/> (einschließlich Typen vertraulicher Informationen)**|**Aktionen**|
|:-----|:-----|:-----|
|Leise EU vertrauliche Inhalte gefunden  <br/> | Inhalt enthält vertrauliche Informationen:  <br/>  EU Debit Card-Nummer – Min. Anzahl 1, Max. Anzahl 9  <br/>  EU Führerscheinnummer – Min Count 1, die maximale Anzahl an 9  <br/>  EU National Identification Number-Min Count 1 maximale Anzahl 9  <br/>  EU Reisepassnummer – Min Count 1 maximale Anzahl 9  <br/>  EU Sozialversicherungsnummer (SSN) oder die entsprechende ID – Min Count 1, die maximale Anzahl an 9  <br/>  EU Tax Identification Anzahl (US) – Min Count 1 maximale Anzahl 9  <br/>  Inhalt wird weitergegeben an:  <br/>  Personen außerhalb meiner Organisation  <br/> |Berichte Vorfall an Administrator senden  <br/> |
|Große Menge von EU vertrauliche Inhalte gefunden  <br/> | Inhalt enthält vertrauliche Informationen:  <br/>  EU Debit Card-Nummer – Min. Anzahl 1, Max. Anzahl 9  <br/>  EU Führerscheinnummer – Min Count 1, die maximale Anzahl an 9  <br/>  EU National Identification Number-Min Count 1 maximale Anzahl 9  <br/>  EU Reisepassnummer – Min Count 1 maximale Anzahl 9  <br/>  EU Sozialversicherungsnummer (SSN) oder die entsprechende ID – Min Count 1, die maximale Anzahl an 9  <br/>  EU Tax Identification Anzahl (US) – Min Count 1 maximale Anzahl 9  <br/>  Inhalt wird weitergegeben an:  <br/>  Personen außerhalb meiner Organisation  <br/> | Einschränken des Zugriffs auf den Inhalt für externe Benutzer  <br/>  Benachrichtigen Sie Benutzer mit e-Mail und Richtlinie Tipps  <br/>  Außerkraftsetzung zulassen  <br/>  Geschäftliche Begründung anfordern  <br/>  Berichte Vorfall an Administrator senden  <br/> |
...
|**Regelname**|**Bedingungen <br/> (einschließlich Typen vertraulicher Informationen)**|**Aktionen**|
|:-----|:-----|:-----|
|Inhalte mit US HIPAA übereinstimmt.  <br/> | Enthält die folgenden vertraulichen Informationen an:  <br/>  US Sozialversicherungsnummer (SSN) – Min Count 1, Max zählen alle  <br/>  – Drug Enforcement Agency (DEA) Min Count 1, Max zählt alle  <br/> **UND** <br/>  Inhalt enthält einen dieser Begriffe:  <br/>  International Klassifizierung der Krankheiten (ICD-9-CM) – Min Count 1, Max zählen alle  <br/>  International Klassifizierung der Krankheiten (ICD-10-CM) – Min Count 1, Max zählen alle  <br/>  Inhalt wird weitergegeben an:  <br/>  Personen außerhalb meiner Organisation  <br/> |Benachrichtigung senden  <br/> |
