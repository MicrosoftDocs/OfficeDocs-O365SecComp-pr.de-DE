...
Dieser Artikel ist Teil einer größeren Reihe von Artikeln zur Office 365 Message Encryption. Verwenden Sie die folgende Tabelle, um Informationen schnell zu finden, die Sie benötigen.
  
|||
|:-----|:-----|
|Lesen Sie diesen Artikel...  <br/> |Wenn Sie sind...  <br/> |
|[Erfahren Sie mehr über geschützte Nachrichten in Office 365](https://support.office.com/article/2baf3ac7-12db-40a4-8af7-1852204b4b67.aspx) <br/> |Ein Endbenutzer, die Weitere Informationen möchte verschlüsselt Nachrichten Arbeit und welche Optionen stehen zur Verfügung stehen.  <br/> |
|[Wie öffnen kann ich eine geschützte Nachricht?](https://support.office.com/article/1157a286-8ecc-4b1e-ac43-2a608fbf3098.aspx) <br/> |Ein Endbenutzer, die möchte, eine geschützte Nachricht lesen, die an Sie gesendet wurde. Dieser Artikel enthält Informationen zum Lesen von Nachrichten in verschiedenen Versionen von Outlook und von anderen e-Mail-Konten, einschließlich außerhalb von Office 365 wie Google Mail und Yahoo! Konten.  <br/> |
|[Senden Sie, zeigen Sie an und beantworten Sie verschlüsselter Nachrichten in Outlook](https://support.office.com/article/eaa43495-9bbb-4fca-922a-df90dee51980.aspx) <br/> |Ein Endbenutzer, die möchte senden, anzeigen oder Antworten auf eine verschlüsselte Nachricht in Outlook. Auch wenn Sie kein Mitglied einer Office 365-Organisation sind, erhalten Sie weiterhin Benachrichtigung von verschlüsselten Nachrichten in Outlook an Sie gesendet. Verwenden Sie diesen Artikel eine Anleitung zum Anzeigen und beantworten verschlüsselter Nachrichten, die von Office 365 gesendet.  <br/> |
|[Senden einer digital signierten oder verschlüsselten Nachricht](https://support.office.com/article/a18ecf7f-a7ac-4edd-b02e-687b05eff547) <br/> |Ein Endbenutzer, die möchte senden, anzeigen oder Antworten auf verschlüsselte Nachrichten mithilfe von Outlook für Mac. Dieser Artikel behandelt auch über Verschlüsselungsmethoden als OME, wie S/MIME.  <br/> |
...
Office 365-Nachrichtenverschlüsselung ist ein Onlinedienst, der auf Microsoft Azure-Rechteverwaltung (RMS Azure) der Teil des Azure Information Protection ist aufbaut. Office 365-Administratoren können Mail Flow Regeln zum Bestimmen der Bedingungen für die Verschlüsselung definieren. Beispielsweise kann eine Regel die Verschlüsselung aller Nachrichten an einen bestimmten Empfänger adressiert ist erforderlich.
  
Wenn eine e-Mail-Nachricht in Exchange Online gesendet wird, die mit eine Verschlüsselung Mail Flow Regel übereinstimmt, wird die Nachricht verschlüsselt, bevor es gesendet wird. Alle Office 365-Endbenutzer, die Outlook-Clients zum Lesen von e-Mails verwenden empfangen systemeigenen, erstklassige Erfahrungen verschlüsselte und durch Rechte geschützten e-Mail-Nachrichten lesen, selbst wenn sie nicht in derselben Organisation als Absender sind. Unterstützte Outlook-Clients umfassen Outlook Desktop, Mac für Outlook, Outlook mobile auf iOS und Android und Outlook Web App.
  
Empfänger von verschlüsselten Nachrichten, die verschlüsselte oder durch Rechte geschützten Nachrichten an ihre Outlook.com, Google Mail und Yahoo Konten erhalten können auf einfache Weise OME-Portal mit ihren Microsoft-Konto oder Google Mail oder Yahoo-Anmeldeinformationen authentifizieren.
  
Endbenutzer, die verschlüsselte oder durch Rechte geschützten Nachrichten auf anderen Clients als Outlook lesen können auch das OME-Portal verschlüsselte und durch Rechte geschützten Nachrichten anzuzeigen, die sie erhalten.
...
E-Mail-Flussregeln sind flexibel, sodass Bedingungen kombiniert werden, damit Sie bestimmte sicherheitsanforderungen in einer einzelnen Regel erfüllen können. Beispielsweise können Sie eine Regel, um alle Nachrichten verschlüsseln, die angegebenen Schlüsselwörter enthalten und werden an externe Empfänger adressiert erstellen. Die neuen Funktionen für Office 365-Nachrichtenverschlüsselung verschlüsselt auch Antworten von verschlüsselten e-Mail-Empfänger.
