...
3. Klicken Sie auf **Weiter**.
  ...
  >[!Tip]
  >Weitere Informationen zum Anpassen können, den Inhalt und Format der Portal-Inhalt finden Sie unter [Verwenden des Editors Communications](using-communications-editor.md).
