...
Erweiterte Spam Filterungsoptionen bieten Administratoren die Möglichkeit, verschiedene Inhaltsattribute einer Nachricht zu überprüfen. Wenn diese Attribute in einer Nachricht vorhanden sind, wird der Spamfaktor der Nachricht erhöht (wodurch das Potenzial für eine Identifizierung als Spam gesteigert wird) oder die Nachricht als Spam markiert wird. Die ASF-Optionen Zielen auf bestimmte Nachrichteneigenschaften wie HTML-Tags und URL-Umleitung, die häufig in Spamnachrichten gefunden werden.
...
> > [!TIP]
> Optionale Informationen, mit denen ein Benutzer erfolgreicher sein kann erwägen Sie, Ihre ASF-Optionen im Testmodus zu aktivieren, um die Spamblockierung basierend auf Ihrer Umgebung zu maximieren. Für Kunden mit hohen Spam Prozentsätzen für bestimmte ASF-Optionen empfiehlt es sich, diese Optionen zunächst zu testen, bevor Sie Sie in Ihrer Produktionsumgebung implementieren. > es wird empfohlen, dass Organisationen, die sich um Phishing kümmern, die Option **SPF-Eintrag: Hard Fail** aktivieren. 
...
der >-Testmodus ist für diese Option nicht verfügbar.  <br/> |X-CustomSpam: SPF-Eintragsfehler  <br/> |
...
der >-Testmodus ist für diese Option nicht verfügbar.  <br/> |X-CustomSpam: Von-SPF-Eintragsfehler  <br/> |
...
> Für beide Szenarien (lokale und in der Cloud gehostete Postfächer) ist es auch nicht erforderlich, diese Einstellung für ausgehende e-Mails zu aktivieren, die über den Dienst gesendet werden, da Unzustellbarkeitsberichte, die legitime Bounce-Nachrichten sind, automatisch erkannt und an den ursprünglichen Absender übermittelt werden. . der >-Testmodus ist für diese Option nicht verfügbar.<br/><br/>> [!TIP]
> Tipp: Weitere Informationen zu Rückläufer Nachrichten und EOP finden Sie unter [Backscatter Messages and EoP](backscatter-messages-and-eop.md).           | X-CustomSpam: Backscatter-NDR<br/> | | Massen-e-Mails  <br/> | Die erweiterte Spamfilterung von Massen-e-Mails wurde zurückgezogen und durch die Schwellenwerteinstellungen für Massen-und e-Mail-Nachrichten ersetzt. Informieren Sie sich über [den Unterschied zwischen Junk-e-Mails und Massen-e-Mails?](what-s-the-difference-between-junk-email-and-bulk-email.md) und [Konfigurieren Sie Ihre Spamfilter Richtlinien](configure-your-spam-filter-policies.md) , um weitere Informationen zu erhalten und die Sett zu konfigurieren.<br/> ||
